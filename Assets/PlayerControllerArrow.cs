...
/// <summary>
/// Simple 2D character controller using Arrow keys.
...
public class PlayerControllerArrow : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Jump: Up arrow (pressed this frame, applied in FixedUpdate)
        ...
        // Note: Down arrow can be used for crouch/drop-through-platform logic if needed.
